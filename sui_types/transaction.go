...
func newWithGasCoinsAllowSponsor(kind TransactionKind, sender SuiAddress, gasPayment []*ObjectRef, gasBudget uint64, gasPrice uint64, gasSponsor SuiAddress) TransactionData {
